       ...
       <header className="header">
        ...
        <nav>
            <ul>
                ...
                <li>
                    <a href="#IT-accomplishments">IT accomplishments</a>
                </li>
                <li>
                    <a href="#Full-Stack-Accomplishments">Full-Stack Accomplishments</a>
                </li>
                <li>
                    <a href="#footer">Contact Information:Resume</a>
                </li>
            </ul>
        </nav>
    </header>
     ...
     className="content"
        ...
        <div id="IT-accomplishments" className="IT-accomplishments">
            ...
            <ul>
                ...
                <li>
                    *
                    In year 2000 recognized by Texas Department of Health EMS Division as an approved EMS software
                    vender.
                </li>
            </ul>
        </div>       
        ...
        <div className ="container-fluid Full-Stack-Accomplishments" id="Full-Stack-Accomplishments">
            ...
            <div className ="container-fluid Full-Stack-Accomplishments" id="Full-Stack-Accomplishments">
                <h2>Full-Stack Accomplishments Continued</h2>
                <div className="row">
